          ...
          <QueryClientContext>
            <ThemeProvider>
              <div className="antialiased bg-white dark:bg-neutral-900 theme-transition">
                ...
                <div className="min-h-screen p-3 bg-gradient-to-t from-green-500 to-lime-400 rounded-2xl theme-transition">

                  <div className="flex min-h-[calc(100vh-24px)] gap-3 items-stretch theme-transition">

                    {/* =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= main content =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */}

                    <main className="flex-1 min-w-0 bg-white text-black dark:text-white bg-white dark:bg-neutral-900 p-6 rounded-xl shadow-lg flex flex-col overflow-hidden theme-transition">
