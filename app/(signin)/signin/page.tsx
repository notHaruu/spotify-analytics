...
export default function HomePage() {
  return (
    <div className="p-5">
      <div className="p-20">
        <h1 className="mt-20 text-8xl text-center pb-10 mb-10 font-bold border-b-2 border-neutral-200 dark:border-neutral-700 theme-transition">Spotify Analytics</h1>
